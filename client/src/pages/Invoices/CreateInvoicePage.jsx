...
export default function CreateInvoicePage({ existingInvoice, onSave }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8  ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-lg shadow-sm shadow-gray-100 border border-slate-200 space-y-4">
          ...
          <InputField
            ...
            type="text"
            name="bussinessName"
            value={formData.billFrom.bussinessName}
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm shadow-gray-100 border border-slate-200 overflow-hidden">
                ...
                <tr key={index} className="hover:bg-slate-50">
                  <td className="px-2 sm:px-6 py-4">
                    <input
                      ...
                      bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm shadow-gray-100 border border-slate-200 flex flex-col justify-center">
          <div className="space-y-4 ">
            ...
            text-lg text-slate-900 border-t
            font-semibold border-slate-200 pt-4 mt-4"
            >
              <p>Total:</p>
              <p>${total?.toFixed(2)}</p>
            </div>
